...
export default class ProductDetail extends React.Component {   
        ...
        if (typeof(contributors)!== "undefined"){
            if (Array.isArray(contributors)){
                for (var i = 0; i < contributors.length; i++) {
                    contributorsToShow.push(<Contributors contributorToShow={contributors[i]} />);                  
                }
            } else {
                contributorsToShow.push(<Contributors contributorToShow={contributors} />);
            }
    ...
    render() {
        return (
            <div>
                <h2>Title: {typeof(this.props.selectedProduct.Title) !== "undefined" ? this.props.selectedProduct.Title.TitleText.toUpperCase() : ''}</h2>
